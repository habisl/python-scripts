...
# hosts_path = r"C:\Windows\System32\drivers\etc\hosts"  # For windows hosts_path can be replaced with temp_hosts 
# hosts_path = "\etc\hosts" # hosts_path can be replaced with temp_hosts for Mac or Linux  
temp_hosts = "hosts"
